...
<body>
    ...
    <table width="100%" align="center" cellspacing="10" cellpadding="0" border="0">
          ...
          <%--  <tr>
                <td align="center" style="border-bottom: #ddd dashed 1px; padding-bottom: 5px;" colspan="2">Date£º<asp:Label ID="lblPutdate" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                            Views£º<script language="javascript" src="/check/news_view.aspx?id=<%=intID %>"></script>
                </td>
            </tr>
            <tr>
