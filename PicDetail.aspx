    ...
    <form id="form1">
        ...
        <asp:Panel ID="PicDetailMoban1" runat="server" Width="100%">
            <div class="update_detail">
                ...
                <div class="update_detail_bot"><a class="prev" href="PicDetail.aspx?ID=<%=intPrevious %>">Previous£º<%=strPrevious %></a><a class="next" href="PicDetail.aspx?ID=<%=intNext %>">Next£º<%=strNext %></a></div>
            </div>
        </asp:Panel>
        <!--Content End-->
